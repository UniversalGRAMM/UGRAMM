...
class Utilities{
    ...
    protected:
    std::vector<std::string> colors;        //Color code for different FunCell nodes
    std::string input_pin_color;            //Pre-defined color-code for the input-pin cell
    std::string output_pin_color;           //Pre-defined color-code for the output-pin cell
    std::string unused_cell_color;          //Pre-defined color-code for the unused cell
    std::map<std::string, std::string> funCellMapping;  //Key-> Device-model node-name :: Value-> Mapped application name.

    public:
    /**
    * @brief Constructur for untilities class
    * 
    * @param 
    * @return 
    */
    ...
    /**
    * @brief Destructor for untilities class
    * 
    * @param 
    * @return 
    */
