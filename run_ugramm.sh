...
# drc_verbose_level=2 #Optional, can be run with 0 -> err [default] : 1-> warn : 2-> info 
...
make && ./UGRAMM --seed $1 --verbose_level $verbose_level --drc_verbose_level 0 --dfile $dfile --afile $afile --config $cfile
